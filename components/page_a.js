...
class List extends Component {
	...
	render() {
		return (
			<li className="li" onMouseOver={this.shows} onMouseOut={this.shows}>
				<input type="checkbox"
				...
				<button className="btn btn-danger" onClick={()=>this.props.deleteItem()} style={{display: this.state.show}}>删除</button>
				{
					this.state.status ?
